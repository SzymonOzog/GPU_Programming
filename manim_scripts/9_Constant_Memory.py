...
class ConstantMemory(VoiceoverScene):
  def construct(self):
    ...
    ratio0 = [0.978, 0.999, 0.993, 0.993, 0.988, 0.988, 0.997, 0.997, 0.994, 0.990, 0.980, 0.973, 0.967, 0.958]
    ratio1 = [1.215, 1.209, 1.475, 1.231, 1.234, 1.249, 1.219, 1.132, 1.281, 1.509, 1.850, 2.226, 2.593, 2.890]
    ratio2 = [1.346, 1.354, 1.585, 1.389, 1.352, 1.304, 1.288, 1.235, 1.492, 1.872, 2.408, 2.990, 3.642, 4.067]
    ratio3 = [1.440, 1.484, 1.222, 1.485, 1.487, 1.348, 1.241, 1.214, 1.459, 2.002, 2.652, 3.342, 4.048, 4.568]
    ratio4 = [1.684, 1.743, 1.428, 1.814, 1.734, 1.564, 1.442, 1.425, 1.881, 2.619, 3.607, 4.900, 5.899, 6.795]
    ratio5 = [1.750, 1.765, 1.439, 1.789, 1.808, 1.512, 1.361, 1.336, 1.860, 2.645, 3.728, 4.943, 6.187, 7.138]
    ratio6 = [1.903, 2.125, 1.906, 1.907, 1.914, 1.618, 1.438, 1.442, 2.044, 2.950, 4.378, 5.867, 7.377, 8.536]
    ratio7 = [2.034, 2.263, 2.029, 2.060, 2.037, 1.694, 1.536, 1.550, 2.223, 3.187, 4.760, 6.466, 8.259, 9.767]
    ratio8 = [2.173, 2.410, 2.173, 2.202, 2.219, 1.810, 1.650, 1.645, 2.428, 3.690, 5.483, 7.506, 9.474, 11.099]
    ratio9 = [2.247, 2.597, 2.339, 2.358, 2.344, 1.899, 1.756, 1.820, 2.676, 4.100, 6.053, 8.363, 10.677, 12.541]
    ratio10 = [2.479, 2.735, 2.508, 2.549, 2.495, 2.004, 1.776, 1.833, 2.802, 4.362, 6.602, 9.169, 11.741, 13.767]
    ratio11 = [2.599, 2.924, 2.660, 2.684, 2.686, 2.125, 1.862, 1.998, 3.036, 4.750, 7.153, 10.032, 12.875, 15.230]
    ratio12 = [2.821, 3.098, 2.867, 2.855, 2.885, 2.226, 2.043, 2.170, 3.298, 5.206, 8.010, 11.056, 14.271, 16.771]
    ratio13 = [2.990, 3.220, 2.988, 3.010, 3.012, 2.307, 2.137, 2.306, 3.530, 5.585, 8.622, 11.787, 15.383, 18.006]
    ratio14 = [3.110, 3.330, 3.154, 3.183, 3.163, 2.411, 2.227, 2.440, 3.745, 6.048, 9.305, 12.892, 16.600, 19.524]
    ratio15 = [3.254, 3.548, 3.326, 3.319, 3.342, 2.536, 2.334, 2.613, 4.045, 6.430, 9.934, 13.862, 17.787, 20.838]
    ratio16 = [3.382, 3.719, 3.471, 3.483, 3.489, 2.620, 2.409, 2.742, 4.192, 6.498, 9.718, 12.865, 15.833, 17.880]
